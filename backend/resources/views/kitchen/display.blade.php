                        ...
                        <div class="flex items-start justify-between mb-3">
                            <div>
                                ...
                                @if($order->customer_name)
                                    <p class="text-xs font-medium text-indigo-600 mt-0.5">{{ $order->customer_name }}</p>
                                @endif
                        ...
                        <ul class="space-y-1 mb-4">
                            @foreach($order->items as $item)
                                <li class="text-sm">
                                    ...
                                    {{-- FIX: tampilkan varian di kitchen --}}
                                    @if($item->variant_name)
                                        <div class="text-xs text-indigo-500 pl-1 mt-0.5 flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    @if($item->special_notes)
                                        <div class="text-xs text-orange-600 pl-1 mt-0.5 italic flex items-center gap-1">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                                <line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/>
                                            </svg>
                                            {{ $item->special_notes }}
