...
<div class="card overflow-x-auto">
    <form method="GET" class="flex gap-3 items-end min-w-max">
        ...
        <div class="ml-auto flex gap-2 items-center">
            ...
            {{-- Tombol Tambah Paket Bundling → langsung ke create --}}
   ...
   onmouseout="this.style.backgroundColor='#16a34a'; this.style.borderColor='#16a34a';">
    ...
    Tambah Bundling
    @if(isset($bundleCount) && $bundleCount > 0)
        <span style="background:white; color:#16a34a; font-size:10px; font-weight:700; min-width:18px; height:18px; border-radius:9px; padding:0 4px; display:inline-flex; align-items:center; justify-content:center; flex-shrink:0;">
            {{ $bundleCount }}
        </span>
    @endif
</a>
    ...
    {{-- ── SEKAT BUNDLING — tampil di bawah produk biasa ── --}}
    ...
    <div class="border-t-2 border-dashed border-gray-200">
        ...
        <div style="display:flex; align-items:center; gap:10px; padding:12px 16px 8px;">
            <span style="font-size:11px; font-weight:700; color:#6b7280; text-transform:uppercase; letter-spacing:0.09em; white-space:nowrap; display:flex; align-items:center; gap:6px;">
                <svg xmlns="http://www.w3.org/2000/svg" style="width:13px;height:13px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg>
                Paket Bundling
            </span>
        ...
        @endphp
        <div class="border-t border-gray-100 transition-colors"
             onmouseover="this.style.backgroundColor='#f0f4ff'"
             onmouseout="this.style.backgroundColor=''">
            <div class="grid py-3 px-4" style="grid-template-columns: 1fr auto auto auto auto; align-items:center; gap:16px;">
                {{-- Nama paket --}}
                ...
                {{-- Badge PAKET --}}
                <div>
                    <span style="background:#ede9fe; color:#6d28d9; border:1px solid #c4b5fd; font-size:10px; font-weight:700; padding:2px 8px; border-radius:6px; white-space:nowrap;">
                        PAKET
                    </span>
                </div>
                {{-- Harga --}}
                <div class="text-right whitespace-nowrap">
                    <p class="font-semibold text-gray-900 text-sm">Rp {{ number_format($bundle->bundle_price, 0, ',', '.') }}</p>
                    @if($savings > 0)
